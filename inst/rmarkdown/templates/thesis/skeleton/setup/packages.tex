...
% Necessário para os ambientes comment/endcomment usados pela ppginf.cls
% no modo defesa (ficha, aprovacao, agradece, dedica são suprimidos)
...
% ── Quadros (UFPR) ──────────────────────────────────────────────────────────
% \newfloat e \newcommand{\listofquadros} são definidos aqui como ponto de
% partida; o nome (floatname) e o título de \listofquadros são sobrescritos
% pelo template.tex via \AtBeginDocument, respeitando element_names_up.
\usepackage{float}
...
% ── Anexo ───────────────────────────────────────────────────────────────────
% Definição de \anexo (similar ao \appendix da ppginf.cls).
% NOTA: \@taganexo é definido em template.tex respeitando o YAML element_names_up;
%       portanto NÃO é redefinido aqui para evitar conflito de "already defined".
\makeatletter
