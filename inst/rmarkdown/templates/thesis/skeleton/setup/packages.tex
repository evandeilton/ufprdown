...
% Fonte principal: lmodern (Computer Modern melhorado, compatível com microtype)
% O template original usa newtxtext/newtxmath, mas há conflito com microtype.
\usepackage{lmodern}

% Fontes para ambientes específicos
...
% ── Correção de Idiomas e Anexo ───────────────────────────────────────────────
% Evita que bookdown/pandoc sobrescrevam as traduções para o inglês.
\AtBeginDocument{
