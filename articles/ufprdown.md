...
- **LaTeX**: TeX Live ou [TinyTeX](https://yihui.org/tinytex/) — no R:
...
Para mais detalhes, consulte o [README do
pacote](https://github.com/evandeilton/ufprdown) e a documentação da
classe **ppginf.cls** (PPGInf/UFPR).
